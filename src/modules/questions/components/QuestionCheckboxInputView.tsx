...
import { sanitizeQuestion } from '../questions-utils';
...
export const QuestionCheckboxInputView: React.FC<QuestionCheckboxInputViewProps> = ({
  question,
  numberQuestion,
  selectedAnswer,
  onSelectedAnswer,
  ...
  const newQuestion: string = sanitizeQuestion(
